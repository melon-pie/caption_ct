...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/home/ai/data/huqipeng/caption_ct/annotations/middle_annotationfile_10_28.json',
                        help='input json file to process into hdf5')
    parser.add_argument('--output_h5', default='/home/ai/data/huqipeng/caption_ct/data/coco_chinese_talk_10_28', help='output h5 file')
