...
def language_eval_chinese(dataset, preds, model_id, split):
    ...
    from caption_eval.pycocoevalcap_master.eval import COCOEvalCap
    m1_score = {}
    m1_score['error'] = 0
    ...
    reference_file = '/home/ai/data/huqipeng/caption_ct/annotations/coco_val_raw_annotationfile_11_10.json'
    ...
    while True:
        ...
        for k, sent in enumerate(sents):
            ...
            if verbose:
                ...
                with open('./full_eval_caption_7_23.txt', 'a') as f:
                    f.write(str(entry['image_id']))
                    f.write(str(entry['caption']))
